...
class QPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.Truth_Table_Constelation = Truth_Table_Constelation = (0.77+0.77j,-0.77+0.77j,-0.77-0.77j,0.77-0.77j)
        self.M = M = len(Truth_Table_Constelation)
        self.sps = sps = 8
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(Truth_Table_Constelation, 1)
    ...
    def get_Truth_Table_Constelation(self):
        return self.Truth_Table_Constelation

    def set_Truth_Table_Constelation(self, Truth_Table_Constelation):
        self.Truth_Table_Constelation = Truth_Table_Constelation
        self.set_M(len(self.Truth_Table_Constelation))
        self.digital_chunks_to_symbols_xx_0.set_symbol_table(self.Truth_Table_Constelation)
