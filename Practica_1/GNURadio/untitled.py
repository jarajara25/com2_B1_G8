...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_number_sink_0_0_0_0_0.set_title("desviación estandar")
        ...
        self.qtgui_number_sink_0_0_0_0.set_title("Potencia media")
        ...
        self.qtgui_number_sink_0_0.set_title("cuadratica")
