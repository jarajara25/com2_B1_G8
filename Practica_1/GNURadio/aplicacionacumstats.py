...
import aplicacionacumstats_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class aplicacionacumstats(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "aplicacionacumstats")
        ...
        self._fm_range = qtgui.Range(100, 1e3, 1, 1000, 200)
        ...
        self._No_range = qtgui.Range(0, 1e-1, 1e-3, 1e-4, 200)
        ...
        self.analog_sig_source_x_0.set_block_alias("analog_sig_source_x_0")
        ...
        self.connect((self.epy_block_1, 0), (self.blocks_divide_xx_0, 0))
...
def main(top_block_cls=aplicacionacumstats, options=None):
